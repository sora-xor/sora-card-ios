...
final class SCExchangeOnboardingVolumeView: UIView {

    var onVolume: ((SCExchangeOnboarding.ExpectedVolume) -> Void)?
    var onContinue: (() -> Void)?
    ...
    func configure(
        variants: [SCExchangeOnboarding.ExpectedVolume],
        selected: SCExchangeOnboarding.ExpectedVolume
    ) {
...
extension SCExchangeOnboarding.ExpectedVolume {
    var title: String {
        switch self {
        case .k10:
            "10,000€"
