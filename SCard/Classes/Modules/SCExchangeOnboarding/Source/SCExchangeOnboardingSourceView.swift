...
final class SCExchangeOnboardingSourceView: UIView {

    var onSource: ((SCExchangeOnboarding.SourceOfFunds) -> Void)?
    var onContinue: (() -> Void)?
    ...
    func configure(
        variants: [SCExchangeOnboarding.SourceOfFunds: Bool]
    ) {
...
extension SCExchangeOnboarding.SourceOfFunds {
    var title: String {
        switch self {
        case .salary:
            "Salary"
